      ...
      try {
        ...
        if (res.success && res.data) {
          ...
          if (previous.length > 0) {
            ...
            const lastBirdsLeft =
              mostRecent.noOfBirdsLeft || mostRecent.noOfBirds || 0
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const calculatedLeft =
        previousBirdsLeft !== null ? previousBirdsLeft - mortality : numBirds - mortality
      ...
      if (previousBirdsLeft !== null && mortality > previousBirdsLeft) {
        setError(
          `Mortality (${mortality}) cannot be greater than birds left from previous record (${previousBirdsLeft})`,
        )
        setSaving(false)
        return
      }
        ...
        <main className="flex-1 overflow-y-auto p-6">
          <div className="space-y-6">
            ...
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                <h1 className="text-2xl font-bold text-slate-900">Log Production</h1>
