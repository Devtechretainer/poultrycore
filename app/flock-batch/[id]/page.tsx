            ...
            <div className="space-y-6 space-y-6">
              <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                  ...
                  <p className="text-slate-600">Loading flock batch information...</p>
                </div>
              </div>
        ...
        <main className="flex-1 overflow-y-auto p-6">
          <div className="space-y-6 space-y-6">
            ...
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                <h1 className="text-2xl font-bold text-slate-900">Edit Flock Batch</h1>
                <p className="text-slate-600">Update the flock batch information below</p>
              </div>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="space-y-4 p-6 bg-white rounded-lg shadow-sm">
                ...
                <p className="text-sm text-slate-600">
                  Update the information for this flock batch
                </p>
              ...
              <div className="flex gap-4">
                ...
                <Button
                  ...
                  disabled={saving}
                >
                  {saving ? "Updating..." : "Update Flock Batch"}
                </Button>
              </div>
            </form>
          </div>
