        ...
        if (prodRecordsRes.success && prodRecordsRes.data) {
          ...
          if (matchingRecord) {
            ...
            if (flock) {
              ...
              const usageDate = new Date(formData.usageDate)
              const ageDays = Math.floor((usageDate.getTime() - startDate.getTime()) / (1000 * 60 * 60 * 24))
          ...
          <div className="space-y-6 space-y-6">
            ...
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                ...
                <p className="text-slate-600">Record feed consumption for a flock</p>
              </div>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="space-y-4 p-6 bg-white rounded-lg shadow-sm">
                ...
                <p className="text-sm text-slate-600">
                  Enter the feed consumption details for the selected date
                </p>
