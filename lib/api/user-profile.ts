...
export async function getUserProfile(username: string): Promise<ApiResponse<UserProfile>> {
  try {
    ...
    const response = await fetch(
      `${API_BASE_URL}/api/UserProfile/findByUserName?normalizedUserName=${encodeURIComponent(normalizedUsername)}`,
      {
        method: "GET",
        headers: {
          accept: "*/*",
...
export async function createUserProfile(data: Partial<UserProfile>): Promise<ApiResponse> {
  try {
    ...
    const response = await fetch(`${API_BASE_URL}/api/UserProfile/create`, {
      method: "POST",
      headers: {
        accept: "*/*",
        "Content-Type": "application/json",
...
export async function updateUserProfile(data: UpdateProfileData): Promise<ApiResponse> {
  try {
    ...
    const response = await fetch(`${API_BASE_URL}/api/UserProfile/update`, {
      method: "POST",
      headers: {
        accept: "*/*",
        "Content-Type": "application/json",
